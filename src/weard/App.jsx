...
const STARTER_CREATORS = [
  {
    ...
    collaboration_groups: [
      ...
      { category: "Beauty", brands: ["Rare Beauty", "Carolina Herrera", "Giorgio Armani", "Flower Knows"] },
      { category: "Fashion", brands: ["Oh Polly", "House of CB", "WISKII Activewear", "NA-KD Apparel"] },
    ],
    recent_campaigns: [],
  },
  {
...

{
  name: "Yen",
  category: "Lifestyle",
  instagram: "https://www.instagram.com/loch_yen",
  tiktok: "https://www.tiktok.com/@lochyen",
  email: "yen@weardmgmt.com",
  location: "UK",
  instagram_followers: 47100,
  tiktok_followers: 21200,
  profile_image: MEDIA.creators.Yen.hero,
  photo: MEDIA.creators.Yen.poster,
...

{
  ...
  audience_insights: {
    ...
    second_location: { name: "Global", pct: 64 },
    gender_split: { female: 43.5, male: 56.5 },
    top_city: "London",
    age_range: "25-34",
  },
  recent_campaigns: [
